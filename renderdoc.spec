...
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause BSL-1.0 HPND MIT Zlib
...
%prep
%setup -q -n renderdoc-1.1-reduced
cd ..
%setup -q -T -D -n renderdoc-1.1-reduced -b 1
mkdir -p ../swig
cp -r %{_topdir}/BUILD/swig-renderdoc-modified-5/* %{_topdir}/BUILD/renderdoc-1.1-reduced/../swig
%patch1 -p1
...
cp renderdoc/3rdparty/glslang/LICENSE.md %{buildroot}/usr/share/package-licenses/renderdoc/renderdoc_3rdparty_glslang_LICENSE.md
...
/usr/share/package-licenses/renderdoc/renderdoc_3rdparty_glslang_LICENSE.md
